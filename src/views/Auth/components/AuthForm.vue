...
<template>
    <a-form
        ...
        :rules="props.rules"
    >
        <a-form-item name="mail_address" :label="t('auth.label.mail_address')">
            <a-input
        ...
        >
            <a-input-password
                ...
                type="password"
                :placeholder="t('auth.label.password_confirmation')"
                @blur="trim('password_confirmation', formState)"
            />
        </a-form-item>
        <a-form-item name="role" class="role" :label="t('auth.label.role')">
            <a-select
                ref="select"
